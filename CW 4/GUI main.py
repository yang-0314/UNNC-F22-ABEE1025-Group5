...
win1.title('This is our own software!')    # setting title of the window
win1.geometry('600x200')     # setting the size of the window
def start():     # def the function of the button
    ...
    lab = tk.Label(win, text ='Please choose the number of layers of building material you want to analyze',
...
# for the window to display
    ...
    choose_but_2 = tk.Button(win, text = '4', width=10, height=5, command = run_4)
    choose_but_3 = tk.Button(win, text = '5', width=10, height=5, command = run_5)
    choose_but_4 = tk.Button(win, text = '6', width=10, height=5, command = run_6)
...
btn= tk.Button(win1,text="Click Me To Know More infomation", width=50, height=5, font=('Arial',10,'bold'), command=start, 
            bg='yellow',activebackground='light yellow')
btn.place(x=95, y=50)
win1.mainloop()      # running the loop that works as a trigger
